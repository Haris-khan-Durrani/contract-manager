  ...
  <div class="app-layout">
    ...
    <aside class="sidebar">
      ...
      <div style="flex: 1; overflow-y: auto; padding: 8px 0;">
        ...
        <!-- Contracts -->
        <div class="sidebar-section-label">Contracts</div>
        ...
        <router-link to="/contracts/new" class="nav-item" active-class="active">
        ...
        <template v-if="auth.hasRole(['ADMIN', 'SUPER_ADMIN'])">
          <div class="sidebar-section-label">Studio & Templates</div>
          ...
          <router-link to="/forms" class="nav-item" active-class="active">
          ...
          <router-link to="/ghl" class="nav-item" active-class="active">
      ...
      <!-- User Info (Bottom) -->
      <div style="padding: 12px 14px; border-top: 1px solid var(--color-border); background: #ffffff;">
        <div style="display: flex; align-items: center; justify-content: space-between; gap: 8px;">
          <div style="display: flex; align-items: center; gap: 10px; overflow: hidden; flex: 1;">
            <div style="width: 34px; height: 34px; border-radius: 50%; background: #eff6ff; border: 1px solid #bfdbfe; color: #1d4ed8; display: flex; align-items: center; justify-content: center; font-weight: 700; font-size: 0.85rem; flex-shrink: 0;">
              {{ userInitial }}
            </div>
    ...
    <div class="main-wrapper">
      <header class="topbar">
        <!-- Left: Location / Sub-account selector pill (Ref: Image) -->
